...
import type { MergeDiffStats, IMFileMergeReview, IMMergeSummary } from "../../services/index";
export type { MergeDiffStats } from "../../services/index";
...
export type HandleIntentResult =
  ...
  | { mode: typeof ResultMode.TURN; id: string; duplicate?: boolean };
