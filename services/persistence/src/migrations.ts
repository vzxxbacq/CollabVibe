...
export const MIGRATIONS: string[] = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_merge_sessions_project_state ON merge_sessions(project_id, state);`,
  `ALTER TABLE merge_sessions ADD COLUMN recovery_error TEXT;`,
  `ALTER TABLE merge_sessions ADD COLUMN resolver_backend_id TEXT;`,
