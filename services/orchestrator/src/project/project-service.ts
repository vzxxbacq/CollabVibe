...
import { detectDefaultBranch, initRepo, setRemoteUrl, ensureWorkBranch } from "../../../../packages/git-utils/src/index";
...
export class ProjectSetupService {
  ...
  async setupFromInitCard(input: SetupProjectInput): Promise<SetupResult> {
    ...
    await ensureWorkBranch(resolved, workBranch, defaultBranch);
