...
- See [Feishu Integration](/en/00-overview/platform-feishu) for the platform steps
- If you just want to understand the current state, you can also review [Slack Integration](/en/00-overview/platform-slack)
...
- To understand the whole system: [System Overview](/en/00-overview/system-overview)
- To understand the three core entities: [Core Entities: Project / Thread / Turn](/en/01-architecture/architecture)
